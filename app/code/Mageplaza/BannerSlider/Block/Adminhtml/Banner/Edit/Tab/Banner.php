...
class Banner extends Generic implements TabInterface
{
     ...
     * @param Category $categoryOptions
     * @param array $data
     */
    public function __construct(
        ...
        $this->categoryOptions = $categoryOptions ?: \Magento\Framework\App\ObjectManager::getInstance()->get(Category::class);
    ...
    protected function _prepareForm()
    {
        ...
        $categorySelect = $fieldset->addField('category', 'select', [
            'name' => 'category',
            'label' => __('Category'),
            'title' => __('Category'),
            'values' => $this->categoryOptions->toOptionArray(),
            'note' => __('Select whether this banner is for website or mobile view')
        ]);
