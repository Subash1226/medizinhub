    ...
    public function getTitle()
{
    ...
    $trimmedTitleValue = ($titleValue !== null) ? trim($titleValue) : null;
    
    return ($trimmedTitleValue) ? $trimmedTitleValue : \Sp\Orderattachment\Model\Attachment::DEFAULT_TITLE_ATTACHMENT;
}
