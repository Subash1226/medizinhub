...
class MobileNumber extends \Magento\Eav\Model\Entity\Attribute\Backend\AbstractBackend
{
    ...
    {
        $mobileNumber = $object->getData(AddCustomerAttributes::MOBILE_NUMBER);
        $countryCode = $object->getData(AddCustomerAttributes::COUNTRY_CODE);
        if ($mobileNumber && $countryCode) {
            $collection = $this->customerCollectionFactory->create()
                ->addAttributeToFilter(AddCustomerAttributes::MOBILE_NUMBER, $mobileNumber)
                ->addAttributeToFilter(AddCustomerAttributes::COUNTRY_CODE, $countryCode);
