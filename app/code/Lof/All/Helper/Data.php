...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     */
    protected $_moduleReader; // Declare the property here
    ...
    public function __construct(
        ...
        $this->_license        = $licnese;  // Assign the value to the declared property
        $this->_moduleReader   = $moduleReader; // Assign the value to the declared property
