...
return [
    'modules' => [
        ...
        'Grasch_CheckoutLoginStep' => 0,
        'Lillik_PriceDecimal' => 1,
        'MageWorx_SearchSuiteAutocomplete' => 1,
        'Magecomp_Discountpercentage' => 1,
        'Magecomp_Extrafee' => 1,
        'Magelearn_Customform' => 1,
        'Magenizr_HideShippingMethod' => 1,
        'Magezon_Core' => 1,
        'Magezon_CustomerApproval' => 1,
        'MedizinhubCore_ConfirmOrder' => 1,
        'MedizinhubCore_ConsultOption' => 1,
        'MedizinhubCore_Doctor' => 1,
        'MedizinhubCore_Home' => 1,
        'MedizinhubCore_Lab' => 1,
        'MedizinhubCore_MostBooked' => 1,
        'MedizinhubCore_Product' => 1,
        'Niks_Admintheme' => 1,
        'PayPal_Braintree' => 1,
