...
//                 var prescription = document.getElementById('sp-checkout');

//                 // Display the current URL in an alert
//                 alert('Current: ' + prescription);
//                 // Retrieve the elements with ids "shipping-checkout", "payment", and "sp-checkout"
//                 var shipping = document.getElementById('shipping-checkout');
//                 var payment = document.getElementById('payment');
//                 var prescription = document.getElementById('sp-checkout');

//                 // If the element with id "shipping-checkout" exists, hide the "sp-checkout" element
//                 if (shipping) {
//                     prescription.style.display = "none";
//                 }

//                 // If the element with id "payment" exists, hide the "sp-checkout" element
//                 if (payment) {
//                     prescription.style.display = "none";
//                 }
