    ...
    return Component.extend({
        ...
        initialize: function () {
            ...
            hasNewAddress = addressList.some(function (address) {
                setTimeout(function() {
                    $('.checkout-shipping-address').removeClass('checkoutAddress_show');
                }, 100);
        ...
        /**
         * Apply address selection to UI
         */
        applyAddressSelection: function(newShippingAddress) {
            // Update UI to reflect selection
            $('.shipping-address-item').removeClass('selected-item').addClass('not-selected-item');
            $('#address-' + newShippingAddress.customerAddressId).removeClass('not-selected-item').addClass('selected-item');
            
            // Ensure radio button is checked
            $('input[name="shipping-address-selection"]').prop('checked', false);
            $('#radio-' + newShippingAddress.customerAddressId).prop('checked', true);
        },

        /**
         * Save new shipping address - Simplified version
         */
        saveNewAddress: function () {
            ...
            if (!this.source.get('params.invalid')) {
                ...
                // Create and select new address
                newShippingAddress = createShippingAddress(addressData);
                selectShippingAddress(newShippingAddress);
                checkoutData.setSelectedShippingAddress(newShippingAddress.getKey());
                checkoutData.setNewCustomerShippingAddress($.extend(true, {}, addressData));
                
                // Apply address selection to update UI
                this.applyAddressSelection(newShippingAddress);
