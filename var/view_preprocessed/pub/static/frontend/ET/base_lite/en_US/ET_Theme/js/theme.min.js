...
var windowWidth=jQuery(window).width();if(windowWidth<768){jQuery('.footer-columns .content-main .item .item-inner > .title + .content').hide();jQuery(document).on('click','.footer-columns .content-main .item .item-inner',function(){jQuery(this).addClass('active-tab');jQuery(this).find('.content').slideDown();});jQuery(document).on('click','.footer-columns .content-main .item .item-inner > .content',function(e){e.preventdefault();return false;});jQuery(document).on('click','.footer-columns .content-main .item .item-inner.active-tab',function(){jQuery(this).removeClass('active-tab');jQuery(this).find('.content').slideUp();});}});if(jQuery('#faqElement').length>0){jQuery("#faqElement").accordion();}});